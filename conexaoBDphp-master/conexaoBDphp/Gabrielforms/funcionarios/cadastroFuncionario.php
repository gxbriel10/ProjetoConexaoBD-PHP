...
<body>
    <div class="container">
        <div class="form-img">
            <img src="../assets/img/undraw_sharing_knowledge_03vp.svg" >
        </div>
        <div class="form">
...
<?php
	...
	if(!empty($_POST))
	{
        ...
        try {
            $stmt = $connection->prepare("INSERT INTO tb_funcionario (nm_primeiro, nm_sobrenome, dt_nasc, nr_cpf, nr_rg, nr_cep, nr_endereco, nm_pais, nr_celular, nm_email, id_genero)
