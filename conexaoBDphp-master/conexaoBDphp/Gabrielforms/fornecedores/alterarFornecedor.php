...
?>
    <div class="container">
        ...
        <div class="form">
            <form action="confirmarAlterarFornecedor.php" method="POST">
                ...
                <div class="input-group">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" id="cod" name="cod" value="<?php echo $row['cd_fornecedor'];?>" readonly="true">
                    </div>
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" id="produto" name="produto" placeholder="Digite o tipo de produto" value="<?php echo $row['tp_produto'];?>" required>
                    </div>
